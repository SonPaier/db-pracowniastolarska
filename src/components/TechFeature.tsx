...
export default function TechFeature({
  ...
  return (
    <div className="bg-surface-50 rounded-sm overflow-hidden">
      <div className="relative aspect-[4/3] bg-surface-200 flex items-center justify-center">
        {imageSrc ? (
          <Image
            src={imageSrc}
            alt={imageAlt}
      ...
      <div className="p-6">
        <p className="text-[0.6rem] uppercase tracking-[0.15em] text-secondary font-sans mb-1">{subtitle}</p>
        <h4 className="font-serif text-base font-semibold text-primary mb-3">{title}</h4>
