            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div>
                ...
                <div className="flex items-center gap-4 mt-6">
                  <a href="https://www.facebook.com/db.pracownia.stolarska" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-text-light hover:text-secondary transition-colors">
